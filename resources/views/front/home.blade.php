...
<body data-instant-intensity="mousedown">
            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="index.php" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">E-Commerce</span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                @foreach ($categories as $category)
                                    <li><a class="dropdown-item nav-link" href="#">{{ $category->name }}</a>
                                    </li>
            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset={{ asset('front_assets/images/carousel-1-m.jpg') }} />
                            <source media="(min-width: 800px)"
                                srcset={{ asset('front_assets/images/carousel-1.jpg') }} />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset={{ asset('front_assets/images/carousel-3-m.jpg') }} />
                            <source media="(min-width: 800px)"
                                srcset={{ asset('front_assets/images/carousel-3.jpg') }} />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset={{ asset('front_assets/images/carousel-2-m.jpg') }} />
                            <source media="(min-width: 800px)"
                                srcset={{ asset('front_assets/images/carousel-2.jpg') }} />
    ...
    <script src="{{ asset('front_assets/js/instantpages.5.1.3.min.js') }}"></script>
